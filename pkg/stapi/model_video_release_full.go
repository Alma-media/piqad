...
type VideoReleaseFull struct {
	...
	Languages []ContentLanguage `json:"languages,omitempty"`
	// Languages of subtitles
	LanguagesSubtitles []ContentLanguage `json:"languagesSubtitles,omitempty"`
	// Languages that are available with dubbing
	LanguagesDubbed []ContentLanguage `json:"languagesDubbed,omitempty"`
}
